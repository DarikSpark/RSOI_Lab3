...
if (isset($_POST['clientID'])) {$clientID = $_POST['clientID']; }// if ($statusClient == '') {unset($statusClient);} }
...
$result = mysql_query("UPDATE  `user43199_roses`.`clients` SET  
