    ...
    <div class="content">
        ...
        <div class="Page">
            <form method="POST" action="/account/register">
                ...
                <br><input type="password" name="password" placeholder="Пароль" maxlength="15" pattern="[A-Za-z-0-9]{1,15}" title="Не менее 5 и неболее 15 латынских символов или цифр." required>
                <br><input type="text" name="lastName" placeholder="Фамилия" maxlength="10" pattern="[А-Яа-яЁё]{4,10}" title="Не менее 4 и неболее 10 латынских символов или цифр." required>
                <br><input type="text" name="firstName" placeholder="Имя" maxlength="10" pattern="[А-Яа-яЁё]{4,10}" title="Не менее 4 и неболее 10 латынских символов или цифр." required>
                <br><input type="text" name="secondName" placeholder="Отчество" maxlength="10" pattern="[А-Яа-яЁё]{4,10}" title="Не менее 4 и неболее 10 латынских символов или цифр." required>
